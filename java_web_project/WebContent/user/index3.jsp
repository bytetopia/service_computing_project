  ...
  <div class="row">
    <div class="col s12 card">
      <div class="card-content">
        <span class="card-title grey-text text-darken-4">下单成功</span>
        <span>系统已为你安排好行程！</span>
      </div>
      <div class="card-content">
        <div class="row">
          <div class="col s12">
            <p>航班服务状态：${order.airlineStatus}</p>
            <p>租车服务状态：${order.carStatus}</p>
            <p>酒店服务状态：${order.hotelStatus}</p>
            <p>景点服务状态：${order.sightStatus}</p>
          </div>
          <br/>
          <div class="col s12">
            <div class="input-field col s12 m8 l4">
              <a class="waves-effect waves-light btn cyan darken-1" href="<c:url value='/OrderServlet?m=viewOrderDetail&oid=${order.orderno}'/>"><i class="material-icons right">arrow_forward</i>查看订单详情</a>
            </div>
          </div>
        </div>
      </div>
